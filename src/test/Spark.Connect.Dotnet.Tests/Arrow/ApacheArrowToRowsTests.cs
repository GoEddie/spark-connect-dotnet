...
public class ApacheArrowToRowsTests : E2ETestBase
{
    ...
    {
        var words = new string[] {"hello", "old", "friend"};
    ...
    public async Task CanConvertTimestampArrow_DateTimeOffset()
    {
        ...
        {
            DateTime.Parse("2021-01-01 01:01:01"), DateTime.Parse("2022-02-02 02:02:02"),
            DateTime.Parse("2023-03-03 03:03:03")
        };
        ...
        TimestampArray timestampArray = timestampBuilder.Build();
    ...
    public async Task CanConvertDate32Arrow_DateTime()
    {
        var dates = new DateTime[]
        {
            ...
            DateTime.Parse("2022-02-02 00:00:00"),
            DateTime.Parse("2023-03-03 00:00:00")
        };
        ...
        Date32Array date32Array = dateBuilder.Build();
    ...
    public async Task CanConvertDate64Arrow_DateTime()
    {
        ...
        Date64Array date64Array = dateBuilder.Build();
    ...
    public async Task CanConvertMapArrow_Dictionary()
    {
        ...
        MapArray mapArray = mapBuilder.Build();
