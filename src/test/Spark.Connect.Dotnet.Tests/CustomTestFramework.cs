...
public class CustomTestFramework : XunitTestFramework
{
    ...
    private class CustomAssemblyRunner : XunitTestAssemblyRunner
    {
        ...
        {
            return new CustomTestCollectionRunner(testCollection, testCases, DiagnosticMessageSink, messageBus,
    ...
    private class CustomTestCollectionRunner : XunitTestCollectionRunner
    {
        ...
        {
            return new CustomTestClassRunner(testClass, @class, testCases, DiagnosticMessageSink, MessageBus,
    ...
    private class CustomTestClassRunner : XunitTestClassRunner
    {
        ...
        {
            return new CustomTestMethodRunner(testMethod, Class, method, testCases, DiagnosticMessageSink, MessageBus,
    ...
    private class CustomTestMethodRunner : XunitTestMethodRunner
    {
        ...
        public CustomTestMethodRunner(ITestMethod testMethod, IReflectionTypeInfo @class, IReflectionMethodInfo method,
            IEnumerable<IXunitTestCase> testCases, IMessageSink diagnosticMessageSink, IMessageBus messageBus,
            ExceptionAggregator aggregator, CancellationTokenSource cancellationTokenSource,
...
internal class CustomTestMethodRunner : XunitTestMethodRunner
{
    private readonly IMessageSink _diagnosticMessageSink;
