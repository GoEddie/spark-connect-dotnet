...
public class UnresolvedColumnWithSuggestionException : SparkException{
    ...
    public UnresolvedColumnWithSuggestionException(string exceptionMessage, Exception exception) : base(exceptionMessage, exception)
    {
...
public class WindowFunctionWithoutOverException : SparkException{
    ...
    public WindowFunctionWithoutOverException(string exceptionMessage, Exception exception) : base(exceptionMessage, exception)
    {
        ...
        OverrideMessage = $@"The Window Function `{FunctionsWrapper.CSharpFunctionName(windowFunction)}` requires an OVER clause";
