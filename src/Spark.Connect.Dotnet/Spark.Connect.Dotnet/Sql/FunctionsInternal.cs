...
public class FunctionsInternal
{
    ...
    private static Expression ColumnNameToExpression(string columnName)
    {
        return new Expression
        {
            UnresolvedAttribute = new Expression.Types.UnresolvedAttribute
    ...
    protected internal static Expression FunctionCall2(string function, bool isDistinct, List<string> parameters)
    {
        return FunctionCall2(function, isDistinct, parameters.Select(ColumnNameToExpression).ToArray());
    }

    protected internal static Expression FunctionCall2(string function, bool isDistinct, List<Column> parameters)
    {
        return FunctionCall2(function, isDistinct, parameters.ToArray());
    }
    ...
    protected internal static Expression FunctionCallColumns(string function, bool isDistinct, Expression expression,
        string column)
    {
        return FunctionCall2(function, isDistinct, expression, ColumnNameToExpression(column));
    }

    protected internal static Expression FunctionCallColumns(string function, bool isDistinct, Expression expression,
        Column column)
    {
        return FunctionCall2(function, isDistinct, expression, column.Expression);
    }
