...
/// <summary>
///Gradient-Boosted Trees (GBTs) learning algorithm for classification. It supports binary labels, as well as both continuous and categorical features. </summary>
public class GBTClassifier : Estimator<GBTClassifierModel>
{
    /// <summary>
    /// Represents the Gradient-Boosted Trees (GBT) algorithm for classification tasks.
    /// This class supports training a GBT model on datasets with binary classification labels.
    /// It can work with both continuous and categorical features.
    /// </summary>
    public GBTClassifier(ParamMap paramMap) : base(IdentifiableHelper.RandomUID("gbt-static"), "org.apache.spark.ml.classification.GBTClassifier", paramMap)
    {
    ...
    /// </summary>
    public GBTClassifier() : this(DefaultParams.Clone())
    {
    ...
    /// </summary>
    public GBTClassifier(IDictionary<string, dynamic> paramMap) : this(DefaultParams.Clone().Update(paramMap))
    {
    ...
    [
        ...
        new("lossType", "logistic"),
        new("maxIter", 20),
        new("stepSize", 0.1),
        new("seed", null),
        new("subsamplingRate", 1.0),
        new("impurity", "variance"),
        new("featureSubsetStrategy", "all"),
        new("validationTol", 0.01),
        new("validationIndicatorCol", null),
        new("leafCol", ""),
